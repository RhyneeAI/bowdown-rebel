...
<div class="container-fluid mt-4">
    <div class="card">
        <div class="card-body">
            <form id="createForm" method="POST" enctype="multipart/form-data" action="{{ route($role.'.category.update', $category->slug) }}">
                @csrf
                @method('PATCH')
                <div class="row">
                ...
                <div class="col-md-12 mt-4 text-end">
                    <a href="{{ route($role.'.category.index') }}" class="btn btn-secondary">Kembali</a>
